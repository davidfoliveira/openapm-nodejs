...
var LevitateEvents = /*#__PURE__*/ function(_EventEmitter__default_default) {
    _inherits(LevitateEvents, _EventEmitter__default_default);
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 2:
                                ...
                                return [
                                    4,
                                    undici.request(_this.eventsUrl.toString(), {
                                        method: "PUT",
                                        headers: {
...
exports.LevitateEvents = LevitateEvents;
