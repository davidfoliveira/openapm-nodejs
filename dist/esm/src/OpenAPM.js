...
import { LevitateEvents } from "./levitate/events";
import { runInHTTPRequestStore, getHTTPRequestStore } from "./async-local-storage.http";
var moduleNames = {
    express: "express",
    mysql: "mysql2",
    nestjs: "@nestjs/core",
...
var OpenAPM = /*#__PURE__*/ function(LevitateEvents) {
    "use strict";
    _inherits(OpenAPM, LevitateEvents);
    ...
    function OpenAPM(options) {
        ...
        _this.initiatePromClient = function() {
            promClient.register.setDefaultLabels(_this.getDefaultLabels());
            promClient.collectDefaultMetrics({
                gcDurationBuckets: _this.requestDurationHistogramConfig.buckets
            });
            _this.requestsCounter = new promClient.Counter(_this.requestsCounterConfig);
            _this.requestsDurationHistogram = new promClient.Histogram(_this.requestDurationHistogramConfig);
        };
        ...
        _this.initiateMetricsRoute = function() {
            ...
            var _this1 = _assert_this_initialized(_this);
            _this.metricsServer = http.createServer(function() {
                var _ref = _async_to_generator(function(req, res) {
                    var _req_url, path2, metrics;
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                path2 = getSanitizedPath((_req_url = req.url) !== null && _req_url !== void 0 ? _req_url : "/");
     ...
     */ _this._REDMiddleware = function(req, res, next) {
            runInHTTPRequestStore(function() {
                ResponseTime(function(req2, res2, time) {
                    ...
                    var sanitizedPathname = getSanitizedPath((_req2_originalUrl = req2.originalUrl) !== null && _req2_originalUrl !== void 0 ? _req2_originalUrl : "/");
            ...
            value: function instrument(moduleName) {
                ...
                try {
                    ...
                    if (moduleName === "nextjs") {
                        var nextServer = require(path.resolve("node_modules/next/dist/server/next-server.js"));
                        instrumentNextjs(nextServer.default, {
                            getRequestMeta: require(path.resolve("node_modules/next/dist/server/request-meta.js")).getRequestMeta
                        }, {
...
export { OpenAPM, OpenAPM_default as default, getMetricClient };
